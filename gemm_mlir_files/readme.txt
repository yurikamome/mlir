...
1. generate loop-ir
./bin/mlir-opt -linalg-lower-to-loops -cse -canonicalize ./tryblisgemm.mlir  > temp.loops
...
./bin/mlir-opt  -linalg-lower-to-llvm-dialect ./temp.loops | ./bin/mlir-cpu-runner -e matmul -entry-point-result=f32  -shared-libs=/home/li23/latest_mlir/llvm-project/build/lib/libcblas_interface.so > dump.txt 